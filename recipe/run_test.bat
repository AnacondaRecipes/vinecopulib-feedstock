...
%CXX% ./src/main.cpp /EHsc /I %LIBRARY_INC% /I %LIBRARY_INC% /I %LIBRARY_INC%\eigen3 /I %LIBRARY_INC%\boost /I %LIBRARY_INC%\wdm  /I %LIBRARY_INC%\vinecopulib /link /LIBPATH:%LIBRARY_LIB%
